...
@section('content')
    ...
    <div class="data-fieldtable">
        <div class="data-fieldtable">
            <form id="testimonialForm" class="customer-detail-form" enctype="multipart/form-data" method="POST" action="{{ route('admin.testimonials.store')}}">
                @csrf
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('submit', '#testimonialForm', function(e){
            ...
            if($(this).valid()){
                var url = '{{ route("admin.testimonials.store") }}';
