				...
				<div class="row">
					<div class="col-12 col-lg-12 col-xl-5">
						<div class="footer-column ">
							<div class="footer-logo">{{--<a href=""><img src="{{asset('assets/images/logo.png')}}" class="img-fluid" alt="" title="Armor" /></a>--}}<h5 class="footer-title">About Us</h5></div>
							<div class="footer-content">
								...
								<div class="media-icon-with-text d-flex flex-wrap">
									...
									<div class="media-text">
										@if($settings)
											<span class="icon-text-heading">{{ $settings->start_day }} - {{ $settings->end_day }}</span>
											<span class="icon-info">{{ \Carbon\Carbon::parse($settings->start_time)->format('h:i A') }} - {{ \Carbon\Carbon::parse($settings->end_time)->format('h:i A') }}</span>
										@endif
									</div>
								</div>
							</div>
									...
									<a href="tel:1234567890">
										<div class="media-icon-with-text d-flex flex-wrap">
											...
											<div class="media-text">
												...
												<span class="icon-info">{{ $settings->phone }}</span>
											</div>
										</div>
									</a>
								</li>
									...
									<a href="mailto:armor@gmail.com">
										<div class="media-icon-with-text d-flex flex-wrap">
											...
											<div class="media-text">
												...
												<span class="icon-info">{{ $settings->email }}</span>
											</div>
										</div>
									</a>
								</li>
								<li class="address contact-item">
									<div class="media-icon-with-text d-flex flex-wrap">
										...
										<div class="media-text">
											...
											<span class="icon-info">{{ $settings->address }}</span>
										</div>
									</div>
								</li>
							</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						<div class="copyright">Copyright © {{ date('Y') }} All Rights Reserved | {{ $settings->site_name }}</div>
					</div>
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
