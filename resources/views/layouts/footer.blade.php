				...
				<div class="row">
					<div class="col-12 col-lg-12 col-xl-5">
						<div class="footer-column ">
							<div class="footer-logo"><a href=""><img src="{{asset('assets/images/logo.png')}}" class="img-fluid" alt="" title="Armor" /></a></div>
							<div class="footer-content">
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic</p>
								<div class="media-icon-with-text d-flex flex-wrap">
									<div class="media-icon"><img src="{{asset('assets/images/time.svg')}}" class="img-fluid" alt="" /></div>
									<div class="media-text">
										<span class="icon-text-heading">Monday - Saturday</span>
										<span class="icon-info">09:00 Am - 06:00 PM</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-12 col-sm-12 col-md-5 col-lg-4 col-xl-3">
						<div class="footer-contact-details">
							...
							<ul class="list-unstyled mb-0">
								<li class="call-us contact-item">
									<a href="tel:1234567890">
										<div class="media-icon-with-text d-flex flex-wrap">
											<div class="media-icon"><img src="{{asset('assets/images/call-us.svg')}}" class="img-fluid" alt="" /></div>
											<div class="media-text">
												<span class="icon-text-heading">Call Us</span>
												<span class="icon-info">+ 91 9887XXXXX</span>
											</div>
										</div>
									</a>
								</li>
								<li class="email-us contact-item">
									<a href="mailto:armor@gmail.com">
										<div class="media-icon-with-text d-flex flex-wrap">
											<div class="media-icon"><img src="{{asset('assets/images/envelope.svg')}}" class="img-fluid" alt="" /></div>
											<div class="media-text">
												<span class="icon-text-heading">Email Us</span>
												<span class="icon-info">rmkfincorp@gmail.com</span>
											</div>
										</div>
									</a>
								</li>
								<li class="address contact-item">
									<div class="media-icon-with-text d-flex flex-wrap">
										<div class="media-icon"><img src="{{asset('assets/images/location-white.svg')}}" class="img-fluid" alt="" /></div>
										<div class="media-text">
											<span class="icon-text-heading">Address</span>
											<span class="icon-info">RMK Fincorp, Near SBI Bank, Station Road, Chirawa, Rajasthan 333026</span>
										</div>
									</div>
								</li>
							</ul>
			...
			<div class="container">
				<div class="row">
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						<div class="copyright">Copyright © 2025 All Rights Reserved | Rmkfincorp</div>
					</div>
					<div class="col-12 col-sm-6 col-md-6 col-lg-6">
						<ul class="footer-social-icons list-unstyled mb-0 d-flex flex-wrap justify-content-end">
							<li>
								<a href="">
							...
							<li>
								<a href="">
									<svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path d="M0.909623 3.99097C1.3017 3.21663 1.8198 2.54025 2.46392 1.96182C3.10805 1.37407 3.83152 0.926251 4.63434 0.618379C5.4465 0.301179 6.29133 0.142578 7.16883 0.142578C8.09301 0.142578 8.9565 0.305843 9.75933 0.632374C10.5341 0.940246 11.2343 1.38339 11.8597 1.96182L9.84334 3.97698C9.47927 3.63179 9.06853 3.37057 8.61111 3.19331C8.16302 3.01605 7.68226 2.92742 7.16883 2.92742C6.57138 2.92742 6.00194 3.05337 5.4605 3.30526C4.94707 3.54783 4.49431 3.88835 4.10224 4.32683C3.7195 4.76532 3.43478 5.25978 3.24807 5.81021C3.10805 6.2487 3.03803 6.69185 3.03803 7.13966C3.03803 7.58748 3.10805 8.03062 3.24807 8.46911C3.43478 9.01955 3.7195 9.51401 4.10224 9.95249C4.49431 10.391 4.94707 10.7315 5.4605 10.9741C6.00194 11.226 6.57138 11.3519 7.16883 11.3519C8.08367 11.3519 8.87249 11.128 9.53528 10.6802C9.90869 10.4376 10.2167 10.1344 10.4595 9.77057C10.7022 9.40672 10.8609 9.01022 10.9356 8.58106H7.16883V5.86619H13.7641C13.8481 6.34199 13.8901 6.8178 13.8901 7.2936C13.8901 8.34783 13.7081 9.31809 13.344 10.2044C12.9893 11.0814 12.4758 11.8277 11.8037 12.4435C11.2156 12.9846 10.5341 13.3997 9.75933 13.6889C8.96584 13.9875 8.10234 14.1367 7.16883 14.1367C6.24465 14.1367 5.35315 13.9595 4.49431 13.605C3.63548 13.2504 2.87467 12.7467 2.21187 12.0936C1.55841 11.4312 1.05432 10.6709 0.699583 9.81255C0.344848 8.95424 0.16748 8.06328 0.16748 7.13966C0.16748 6.02946 0.414861 4.9799 0.909623 3.99097Z" fill="#DDE1ED"/>
									</svg>
								</a>
							</li>
							<li>
